...
# define RIGHTSUPPLY	((long )(MBK_TRACK_SPACING_ALU2*4 +  MBK_WIDTH_VDD) * SCALE_X)
# define LEFTSUPPLY	((long )(MBK_TRACK_SPACING_ALU2   +  MBK_WIDTH_VDD) * SCALE_X)
# define MIDDLESUPPLY	((long )(MBK_TRACK_SPACING_ALU2) * SCALE_X)
